    ...
    return (
        <View style={styles.container}>
            ...
            <View style={styles.buttonStyleContainer}>
                <View>
                    <Button onPressFunction={() => navigation.navigate('RegisterOccurrence')} icon={<MaterialIcons name="assignment" size={80} color="white" />} buttomColor={"white"} color={"#6FBAFF"} title={'Solicitar'} />
                </View>
                <View>
